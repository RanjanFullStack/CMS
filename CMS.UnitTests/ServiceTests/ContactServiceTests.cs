...
namespace CMS.UnitTests.ServiceTests
{
    public class ContactServiceTests
    {
        ...
        public async Task GetContactsAsync_ReturnsApiResult()
        {
            ...
            {
                new ContactDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com" },
                new ContactDTO { Id = 2, FirstName = "Jane", LastName = "Doe", Email = "jane@example.com" }
            };
        ...
        {
            // Arrange
            var contact = new ContactDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "john@example.com" };
        ...
        {
            // Arrange
            var newContact = new ContactDTO { FirstName = "Alice", LastName = "Smith", Email = "alice@example.com" };
            ...
            _contactRepositoryMock.Verify(repo => repo.AddAsync(It.IsAny<ContactDTO>()), Times.Once);
        }
        ...
        {
            // Arrange
            var updatedContact = new ContactDTO { Id = 1, FirstName = "John", LastName = "Doe", Email = "john.doe@example.com" };
